...
class ResultScreen extends StatelessWidget {
  ...
  Widget _videoView() {
    return Padding(
      ...
      child: Column(
        children: [
          Text('Here’s your AI video, ${flow.name}! 🎨',
              style: const TextStyle(fontSize: 30, fontWeight: FontWeight.w800)),
          const SizedBox(height: 4),
          const Text('Painted by AMD Ryzen AI — Van Gogh style',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Scan to take it home',
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            GradientButton(
                label: 'DONE', icon: Icons.refresh, onPressed: flow.reset),
          ]),
        ],
      ),
    );
